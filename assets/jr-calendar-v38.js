...
(function(root){
  ...
  function buildICS(games,now=Date.now()){
    const lines=['BEGIN:VCALENDAR','VERSION:2.0','PRODID:-//Liga Juventino Rosas//V38//ES','CALSCALE:GREGORIAN','METHOD:PUBLISH','X-WR-CALNAME:Liga Juventino Rosas'];
  ...
  root.JRCalendarV38={buildICS,download};if(typeof module!=='undefined')module.exports={buildICS,fold,esc};
