...
Write-Host "============================================================"
Write-Host " PUBLICAR V38 FIX15 EN GITHUB PAGES"
Write-Host "============================================================"
Write-Host ""
...
& node (Join-Path $Repo "scripts\test-v38-fix15.js") $Repo
if($LASTEXITCODE -ne 0){throw "FIX15 no paso pruebas. main no fue tocado."}
...
try{
  ...
  & git -C $Repo merge --no-ff $Feature -m "Publish V38 FIX15 anti-freeze"
...
if($published){
  ...
  Write-Host ""
  Write-Host "PUBLICADO FIX15." -ForegroundColor Green
  Start-Process "https://jairofrancog7-star.github.io/Liga_Futbol/?refresh=38-15&n=$n"
}
Read-Host "Enter"
